          ...
          <div class="col-sm-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <img class="img-cricle userphoto" src="/eximoo/resources/images/admin/${admin.adminphoto}" alt="people"> &nbsp; ${admin.name}</td>
                    <td><c:out value="${admin.email}" /></td>
                    <td><c:out value="${admin.password}" /></td>
                    <td><c:out value="${admin.birthdate}" /></td>
                    <td><c:out value="${admin.phone}" /></td>
                    <td><c:out value="${admin.address}" /></td>
                   
                    <td>
                        <a href="/eximoo/admin/editAdmin/${admin.adminid}"><i class="fas fa-pen-square"></i></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/eximoo/admin/deleteAdmin/${admin.adminid}"><i class="fas fa-trash"></i></a>                     
                    </td>
                </tr>
            </c:forEach>
                  </tbody>
